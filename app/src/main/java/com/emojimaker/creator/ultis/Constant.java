...
public class Constant {
    ...
    public static final String KEY_COUNT_BACKPRESS = "count_backpress";
    ...
    public static final String MYFOLDER = "emoji_maker";
    public static final String NAME_FOLDER_SAVE = "emojimakerpro";
    ...
    public static final String WALLPAPER_EDIT = "wallpaper_edit";
